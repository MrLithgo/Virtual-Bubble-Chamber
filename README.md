...
#toggle-magnetic-field:hover {  
  opacity: 0.8;  
}  
  
#toggle-magnetic-field.off {  
...
<select id="preset-select">   
  ...
  <input id="mass" type="number" min="0" step="1" value="1">    
   ...
   <input type="number" id="energy" min ="0" step="0.01" value="0.50">  
  ...
  <input id="magnetic-field-strength" type="number"  step="0.1" value="0.5">  
   ...
   <button id="toggle-magnetic-field">Toggle Magnetic Field</button>  
   <button id="add-particle">Add Particle</button>  
   <button id="clear-button">Clear chamber</button>  
  </div>  
  <button id="show-radius-button" style="display: none;">Show Radius</button>  
  <div id="radius-hint-box" style="display: none;"></div>  
    
<div id="hint-box" class="hint-box" style="display: none;">What must the minimum energy of the photon be in order to produce an electron-positron pair?</div>
  </div>   
